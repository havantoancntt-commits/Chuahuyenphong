...
const translations: Translations = {
  vi: {
    ...
    'profile.title': 'Hồ sơ Đạo hữu',
    'profile.dharma_id': 'Pháp danh ID',
    'profile.merit': 'Công đức',
    'profile.streak': 'Ngày tinh tấn',
    'profile.stats': 'Thống kê tu tập',
    'profile.bell_rings': 'Tiếng chuông tỉnh thức',
    'profile.prayers': 'Lời nguyện cầu',
    'profile.repentance': 'Lòng sám hối',
    'profile.copy_id': 'Sao chép ID',
    'profile.id_copied': 'Đã sao chép ID',
  ...
  en: {
    ...
    'profile.title': 'Dharma Profile',
    'profile.dharma_id': 'Dharma ID',
    'profile.merit': 'Merit Points',
    'profile.streak': 'Daily Streak',
    'profile.stats': 'Practice Stats',
    'profile.bell_rings': 'Awakening Bells',
    'profile.prayers': 'Prayers Offered',
    'profile.repentance': 'Repentance Acts',
